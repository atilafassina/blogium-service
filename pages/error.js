...
<html lang="en">
  <head>
    <meta charset="UTF-8">
    <title>Blogium-Service / ${msg}</title>
    <style>
      body {
        background: #000;
      ...
      em {
        color: rgb(30,200,10);
        border-bottom: 2px dashed rgb(30,200,10);
      }
